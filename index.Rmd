...
```{javascript, echo=TRUE, eval=FALSE}
<script>
...
.center[
<img src="img/article-tuberculosis.png" height="500px" alt="Bioconductor hexsticker"></img>
]

---

# Continued contributions to the Bioconductor project
